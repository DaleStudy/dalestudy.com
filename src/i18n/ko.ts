...
export const ko: Messages = {
  ...
  home: {
    heroTag: "함께 성장하는 오픈 소스 커뮤니티",
    heroTitle1: "평범한 개발자들이 함께 만드는",
    heroTitle2: "특별한 프로젝트",
    heroSub:
      "오픈 소스 프로젝트와 그룹 스터디를 통해 실제 협업을 경험하세요. 코드 리뷰, 페어 프로그래밍, 그리고 서로의 성장을 응원하는 동료들이 기다립니다.",
    missionSummary:
      "달레 스터디는 오픈 소스 프로젝트를 통해 개발자들이 실무처럼 협업하며 성장하도록 돕습니다. 실력의 문턱 없이, 기여하려는 마음만 있다면 누구나 함께할 수 있습니다.",
    ...
    showcaseTitle: "우리가 만든 오픈 소스",
    showcaseSub:
      "참여의 결과는 말이 아니라 제품으로 남습니다. 모두 오픈 소스로 공개되어 있고, 지금도 발전하고 있습니다.",
    showcase: [
      {
        title: "달레 UI 디자인시스템",
        desc: "한국어 환경에 특화된 오픈 소스 React 디자인 시스템. 실제 프로젝트에서 사용됩니다.",
        host: "daleui.com",
  ...
  about: {
    title: "소개",
    intro: "달레 스터디는 개발자들이 함께 배우고, 만들고, 성장하는 오픈 소스 커뮤니티입니다.",
    missionLabel: "미션",
    missionMain: "오픈 소스 프로젝트를 통해 개발자들이 실무처럼 협업하며 성장하도록 돕는다.",
    missionSubs: [
      "달레 스터디는 오픈 소스 프로젝트를 중심으로 현업과 유사한 협업 경험을 제공하는 개발자 커뮤니티입니다. 팀을 이루어 설계, 구현, 테스트, 리뷰, 배포까지 소프트웨어 개발 전 과정을 직접 경험하고, 완성된 프로젝트는 실제로 동작하는 서비스로 공개되어 기여자의 실질적인 포트폴리오가 됩니다.",
    ],
    visionLabel: "비전",
    visionMain:
      "개발자가 함께 배우고, 성장하고, 서로 이끄는 지속 가능한 오픈 소스 기반 학습 생태계를 만든다.",
    visionSubs: [
  ...
  programs: {
    hubTitle: "프로그램",
    hubSub:
      "진행 중인 스터디와 프로젝트입니다. 스터디는 참여자의 경험을 지속적으로 개선하기 위해 기수제로 운영되고, 프로젝트는 모두 오픈 소스입니다. 모든 프로그램은 Discord와 GitHub에서 공개적으로 진행됩니다.",
    otherTitle: "기타 프로젝트",
    ...
    cards: [
      ...
      },
      {
        ...
        icon: "palette",
        title: "달레 UI 디자인시스템",
        desc: "한국어 환경에 특화된 오픈 소스 디자인 시스템을 커뮤니티가 함께 만듭니다.",
        fullDesc:
          "한국어 사용자 경험에 특화된 오픈 소스 React 디자인 시스템입니다. 디자이너와 개발자가 함께 이슈 선택부터 릴리스까지 실무와 같은 협업 프로세스를 경험합니다.",
        tag: "상시 모집",
        tagTone: "success",
      },
      {
  ...
  programDetail: {
    ...
    details: {
      leetcode: {
        ...
        overview:
          "개발자 해외 취업의 관문인 코딩 인터뷰를 준비하는 스터디입니다. 15주 동안 매주 5문제씩 Blind 75를 함께 풀고, 오픈 소스 프로젝트처럼 GitHub PR로 답안을 제출해 상호 코드 리뷰를 합니다. 리더보드로 서로의 꾸준함을 응원합니다.",
      ...
      ai: {
        ...
        overview:
          "일반 소프트웨어 개발자를 위한 실무 중심 AI 스터디입니다. LLM, 프롬프트 엔지니어링, 컨텍스트 엔지니어링, 하네스 엔지니어링, AI 에이전트, MCP, Skills 같은 최신 기술과 오픈 소스 AI 도구를 함께 익히고, 코드 생성과 업무 자동화처럼 개발 실무에 접목하는 방법을 매주 발표하고 토론합니다.",
        tags: [
          "LLM",
          "프롬프트 엔지니어링",
          "컨텍스트 엔지니어링",
      ...
      daleui: {
        ...
        overview:
          "한국어 환경에 특화된 오픈 소스 React 디자인 시스템을 커뮤니티가 함께 만듭니다. 한국어 타이포그래피와 접근성(WCAG)을 최우선으로 고려하며, 디자이너와 개발자가 이슈 선택부터 PR 리뷰, 릴리스까지 실무와 같은 협업 프로세스를 그대로 경험합니다. npm에 배포되어 실제 프로젝트에서 사용됩니다.",
  ...
  sponsor: {
    ...
    intro2:
      "후원은 단순한 금전적 지원을 넘어, 커뮤니티가 지속 가능할 수 있는 중요한 기반이 됩니다. 받은 도움을 다시 나누는 후원 문화가 해외 오픈 소스 생태계처럼 국내 개발자 커뮤니티에도 뿌리내리기를 바랍니다.",
    quote:
    ...
    uses: [
      ...
      },
      {
        icon: "handHeart",
        title: "오픈 소스 활동 장려",
        desc: "오픈 소스 프로젝트 활동을 장려해 커뮤니티 전체에 더 큰 가치를 만드는 방향으로 집행됩니다.",
      },
    ],
  ...
  seo: {
    home: {
      ...
      description:
        "오픈 소스 프로젝트와 그룹 스터디를 통해 실제 협업을 경험하는 개발자 커뮤니티. 코드 리뷰, 페어 프로그래밍, 그리고 서로의 성장을 응원하는 동료들이 기다립니다.",
    },
    about: {
      title: "소개 | 달레 스터디",
      description:
        "달레 스터디의 미션, 비전, 핵심 가치를 소개합니다. 개발자들이 함께 배우고, 만들고, 성장하는 오픈 소스 커뮤니티입니다.",
    },
    programs: {
      title: "프로그램 | 달레 스터디",
      description:
